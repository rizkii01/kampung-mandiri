...
export const siteProfile: SiteProfile = {
  ...
  tagline: 'Sentra Produksi Tempe Bencongan · Kelapa Dua, Tangerang',
  deskripsi:
    'Kampung Mandiri Sentra Tempe Bencongan merupakan kawasan kampung tempe yang dikelola bersama oleh masyarakat dan Karang Taruna Kelurahan Bencongan, Kecamatan Kelapa Dua, Kabupaten Tangerang. Berawal dari tradisi perajin tempe turun-temurun, kampung ini kini berkembang menjadi sentra produksi tempe yang melibatkan puluhan unit usaha mikro, kecil, dan menengah (UMKM).',
  sejarah:
    'Tradisi pembuatan tempe di Kelurahan Bencongan sudah ada sejak beberapa dekade lalu. Sebagian besar warga menggantungkan hidupnya pada usaha produksi tempe yang diwariskan secara turun-temurun, mulai dari pengolahan kedelai, fermentasi, hingga distribusi ke pasar-pasar tradisional di Tangerang dan sekitarnya.\n\nDengan potensi yang besar tersebut, Karang Taruna Kelurahan Bencongan menggagas program kerja "Kampung Mandiri" untuk membina, mengorganisir, dan mendigitalkan potensi UMKM tempe di kampung ini. Program ini menjadikan Bencongan sebagai kampung tempe yang mandiri secara ekonomi, terorganisir dengan baik, dan dikenal luas oleh masyarakat.\n\nMelalui pendampingan produksi, peningkatan higienitas, serta pemasaran bersama, para perajin kini dapat memasarkan produknya lebih luas — tidak hanya pasar lokal, tetapi juga ke kota-kota besar di sekitar Jabodetabek.',
  visi:
