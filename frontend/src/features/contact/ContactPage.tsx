    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <Card className="mt-10 overflow-hidden">
          <div className="grid items-center gap-8 bg-emerald-600 p-8 sm:p-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                {data.instagram && (
                  ...
                  >
                    <Button
                      size="lg"
                      className="border border-emerald-400/40 bg-emerald-700/40 text-white hover:bg-emerald-700/60"
                    >
            ...
            <div className="hidden lg:block">
              <div className="rounded-2xl bg-white/10 p-6 text-sm leading-relaxed text-emerald-50">
